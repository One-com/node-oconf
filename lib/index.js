...
module.exports.load = function load(rootFileName, options) {
    ...
    return (function readFileAndResolve(fileName) {
        ...
        return (function resolveIncludesAndPublic(obj) {
            if (Array.isArray(obj)) {
                return obj.map(resolveIncludesAndPublic);
                ...
                if (typeof obj['#public'] !== 'undefined') {
                    obj = cjson.extend(true, obj['#public'], obj);
                    delete obj['#public'];
                }

                Object.keys(obj).forEach(function (key) {
                    obj[key] = resolveIncludesAndPublic(obj[key]);
                });
            }
            return obj;
